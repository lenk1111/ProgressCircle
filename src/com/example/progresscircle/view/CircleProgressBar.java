package com.example.progresscircle.view;
...
//[start]------中心白色圆------------------------
        ...
        //[绘制]-实心圆
        canvas.drawCircle(this.getWidth()/2,  this.getHeight()/2, this.height / 2 - pathWidth - 25, p);// 
        canvas.drawCircle(this.getWidth()/2,  this.getHeight()/2, this.height / 2 - pathWidth - 25+0.5f, pathPaint);
//[end]----------------------------------------
	}
